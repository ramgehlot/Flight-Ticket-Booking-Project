...
<a href="http://localhost:8087/Airlines/userloginchek.jsp"><input class="btn btn-primary my-2 my-sm-0"type="button" value="Logout" style="float: right; background-color:black;"></a><br><br>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<form class="form-inline">
						<label >Date:</label>
						<input class="form-control mr-sm-2" type="text" name="date"  pattern="^\S+$" required=true/> 

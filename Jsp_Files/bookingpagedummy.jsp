...
<h1 style="color:blue;">
			...
			<table cellpadding="1">
					...
					<td class="fix_table">
						&nbsp &nbsp &nbsp <input list="destinations" name="destination" placeholder="Enter the Destination" required>
  						<datalist id="destinations">
  						  	<option value="mumbai (Rs:5649)">
  						  	<option value="mysore (Rs:4666)">
  						  	<option value="mangalore (Rs:6999)">
  						  	<option value="chennai (Rs:3500)">
  						  	<option value="hyderabad (RS:2599)">
  						</datalist>
  						</td>
  						<td>
				...
				<%String one = (String) session.getAttribute("org");%>
				<%String two = (String) session.getAttribute("dest");
...
<td><%=Integer.parseInt(rs.getString("FLIGHTID"))%></td>
	...
	%>
		...
		<Label> NOTE:Copy FlightID</Label>
